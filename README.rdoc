...
To benefit from Skinny Spec's scaffolding, you'll need to be using make_resourceful and Haml
...
This wraps an expectation that <tt>User.should_receive(:find).with(:all)</tt>. Using this helper
